...
script_directory="$(pwd)/utils"

run_script_new_tab() {
  osascript -e "tell application \"Terminal\" to do script \"conda activate /Users/sherrykoo/opt/anaconda3 && cd '$script_directory' && python3 '$1'\""
}

osascript -e "tell application \"Terminal\" to do script \"conda activate /Users/sherrykoo/opt/anaconda3 && cd '$(pwd)'/h365 && npm run serve\""
